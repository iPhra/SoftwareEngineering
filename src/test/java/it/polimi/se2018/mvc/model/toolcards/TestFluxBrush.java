...
public class TestFluxBrush {
    ...
    public void testHandleView(){
        fluxBrush.handleView(new ToolCardCLIHandler() {
            @Override
    ...
    public void testHandleCheck(){
        fluxBrush.handleCheck(new ToolCardCheckerHandler() {
            @Override
    ...
    public void testHandleGUI(){
        fluxBrush.handleGUI(new ToolCardGUIHandler() {
            @Override
