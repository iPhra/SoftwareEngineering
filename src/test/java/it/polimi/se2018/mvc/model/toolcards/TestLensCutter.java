...
public class TestLensCutter {
    ...
    @Before
    public void init(){
        lensCutter = LensCutter.instance();
    }
    ...
    public void testHandleView(){
        try {
            lensCutter.handleView(new ToolCardCLIHandler() {
                @Override
    ...
    public void testHandleCheck(){
        lensCutter.handleCheck(new ToolCardCheckerHandler() {
            @Override
    ...
    public void testHandleGUI(){
        lensCutter.handleGUI(new ToolCardGUIHandler() {
            @Override
