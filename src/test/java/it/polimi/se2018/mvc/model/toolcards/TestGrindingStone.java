...
public class TestGrindingStone {
    ...
    @Before
    public void init(){
        grindingStone = GrindingStone.instance();
    }
    ...
    public void testHandleView(){
        grindingStone.handleView(new ToolCardCLIHandler() {
            @Override
    ...
    public void testHandleCheck(){
        grindingStone.handleCheck(new ToolCardCheckerHandler() {
            @Override
    ...
    public void testHandleGUI(){
        grindingStone.handleGUI(new ToolCardGUIHandler() {
            @Override
