...
public class TestCopperFoilBurnisher {
    ...
    @Before
    public void init(){
        copperFoilBurnisher = CopperFoilBurnisher.instance();
    }
    ...
    public void testHandleView(){
        try {
            copperFoilBurnisher.handleView(new ToolCardCLIHandler() {
                @Override
    ...
    public void testHandleCheck(){
        copperFoilBurnisher.handleCheck(new ToolCardCheckerHandler() {
            @Override
    ...
    public void testHandleGUI(){
        copperFoilBurnisher.handleGUI(new ToolCardGUIHandler() {
            @Override
