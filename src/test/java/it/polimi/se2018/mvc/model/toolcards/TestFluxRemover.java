...
public class TestFluxRemover {
    ...
    @Before
    public void init(){
        fluxRemover = FluxRemover.instance();
    }
    ...
    public void testHandleView(){
        fluxRemover.handleView(new ToolCardCLIHandler() {
            @Override
    ...
    public void testHandleCheck(){
        fluxRemover.handleCheck(new ToolCardCheckerHandler() {
            @Override
    ...
    public void testHandleGUI(){
        fluxRemover.handleGUI(new ToolCardGUIHandler() {
            @Override
