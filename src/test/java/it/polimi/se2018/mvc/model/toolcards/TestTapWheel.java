...
public class TestTapWheel {
    ...
    public void testHandleView(){
        try {
            tapWheel.handleView(new ToolCardCLIHandler() {
                @Override
    ...
    public void testHandleCheck(){
        tapWheel.handleCheck(new ToolCardCheckerHandler() {
            @Override
    ...
    public void testHandleGUI(){
        tapWheel.handleGUI(new ToolCardGUIHandler() {
            @Override
