...
public class TestEglomiseBrush {
    ...
    @Before
    public void init(){
        eglomiseBrush = EglomiseBrush.instance();
    }
    ...
    public void testHandleView(){
        try {
            eglomiseBrush.handleView(new ToolCardCLIHandler() {
                @Override
    ...
    public void testHandleCheck(){
        eglomiseBrush.handleCheck(new ToolCardCheckerHandler() {
            @Override
    ...
    public void testHandleGUI(){
        eglomiseBrush.handleGUI(new ToolCardGUIHandler() {
            @Override
