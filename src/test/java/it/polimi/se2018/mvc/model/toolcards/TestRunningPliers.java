...
public class TestRunningPliers {
    ...
    @Before
    public void init(){
        runningPliers = RunningPliers.instance();
    }
    ...
    public void testHandleView(){
        runningPliers.handleView(new ToolCardCLIHandler() {
            @Override
    ...
    public void testHandleCheck(){
        runningPliers.handleCheck(new ToolCardCheckerHandler() {
            @Override
    ...
    public void testHandleGUI(){
        runningPliers.handleGUI(new ToolCardGUIHandler() {
            @Override
