...
public class TestLathekin {
    ...
    public void testHandleView(){
        try {
            lathekin.handleView(new ToolCardCLIHandler() {
                @Override
    ...
    public void testHandleCheck(){
        lathekin.handleCheck(new ToolCardCheckerHandler() {
            @Override
    ...
    public void testHandleGUI(){
        lathekin.handleGUI(new ToolCardGUIHandler() {
            @Override
