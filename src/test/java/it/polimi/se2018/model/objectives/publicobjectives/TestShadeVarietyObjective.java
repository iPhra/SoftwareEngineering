...
import it.polimi.se2018.mvc.model.objectives.publicobjectives.ShadeVarietyObjective;
...
public class TestShadeVarietyObjective {
    ...
    public void init(){
        ...
        shadeVarietyObjective = ShadeVarietyObjective.instance("title", "imagePath");
        shadeVarietyObjective = ShadeVarietyObjective.instance("title", "imagePath");
