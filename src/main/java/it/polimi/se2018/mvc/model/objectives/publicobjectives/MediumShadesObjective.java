...
/**
 * This is the medium shades objective card. It extends {@link PublicObjective}
...
public class MediumShadesObjective extends PublicObjective {
    ...
    private MediumShadesObjective(String imagePath){
        super("Medium Shades", "2 points for each set of 3 & 4 anywhere", imagePath);
    }
    ...
    /**
     * The points are evaluated as it follows: this objective gives 2 points to the player for each set of 3 and 4
     * values anywhere
