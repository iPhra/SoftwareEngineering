...
public class Round {
    ...
    /**
     * Used by {@link it.polimi.se2018.controller.Controller} to check if it's the turn of a player that wants to perform a move
    ...
    /**
     * Used by {@link it.polimi.se2018.controller.ToolCardController} because RunningPliers can be used only by a player
